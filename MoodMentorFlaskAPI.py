...
def faceRecognition():
    try:
        ...
        print(f"Downloading Haar Cascade XML file from {haarcascade_file_key}")
        ...
        print(f"Downloading 'names.pkl' file from {names_file_key}")
        s3.download_file(bucket_name, names_file_key, 'names.pkl')

        # Load the 'names.pkl' file
        print("Loading the 'names.pkl' file...")
